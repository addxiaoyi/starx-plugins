...
public class BlockEntityVersionPatcher {
    ...
    private static final String BLOCK_ENTITY_VERSION = "net/elytrium/limboapi/api/chunk/BlockEntityVersion";
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 3) {
            ...
            System.err.println("  velocity-jar-or-fields: path to Velocity jar (to read ProtocolVersion.class)");
            System.err.println("                         OR comma-separated list of 'FieldName:exists' entries");
            System.err.println("  input-jar:  path to input LimboAPI jar (e.g. limboapi-1.1.27-SNAPSHOT.jar)");
        ...
        System.out.println("  (e.g. MINECRAFT_1_21_11 exists: " + availableFields.contains("MINECRAFT_1_21_11") + ")");
    ...
    static byte[] patchClass(byte[] classBytes, Set<String> validProtocolVersions) {
        ...
        // We scan <clinit> for NEW BlockEntityVersion → GETSTATIC ProtocolVersion.MISSING_FIELD patterns
