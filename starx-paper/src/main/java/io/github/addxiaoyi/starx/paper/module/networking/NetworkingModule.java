...
public final class NetworkingModule implements PaperModule, PluginMessageListener {
  ...
  public void onEnable() {
    plugin.getServer().getMessenger().registerOutgoingPluginChannel(plugin, NETWORKING_CHANNEL);
    plugin
        .getServer()
        .getMessenger()
  ...
  public void onDisable() {
    ...
    plugin.getServer().getMessenger().unregisterOutgoingPluginChannel(plugin, NETWORKING_CHANNEL);
  }
